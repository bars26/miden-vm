...
- Fixed 40 `\begin{cases}...\end{cases}` blocks in the assembly instruction reference docs that were missing the `\\` row separator between cases, which broke KaTeX rendering ([#3650](https://github.com/0xMiden/miden-vm/issues/3650)).
