...
impl<'a, R: PackageRegistry + ?Sized> ProjectDependencyGraphBuilder<'a, R> {
    ...
    fn load_preassembled_dependency(
        ...
        let selected = Version::new(semver, package.commitment());
...
mod tests {
    ...
    fn preassembled_path_dependency_propagates_runtime_dependencies_into_resolution() {
        ...
        let runtime_version =
            Version::new(runtime_package.version.clone(), runtime_package.commitment());
        let dep_package = MastPackage::generate(
            ...
            [miden_mast_package::Dependency {
                ...
                digest: runtime_package.commitment(),
            }],
        );
    ...
    fn preassembled_path_dependency_keeps_embedded_kernel_in_solver_requirements() {
        ...
        let kernel_version =
            Version::new(kernel_package.version.clone(), kernel_package.commitment());
        let dep_package = MastPackage::generate(
            "dep".into(),
            "1.0.0".parse().unwrap(),
            TargetType::Library,
            [miden_mast_package::Dependency {
                ...
                digest: kernel_package.commitment(),
            }],
        );
